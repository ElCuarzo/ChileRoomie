          ...
          <c:if test="${post.imagen2 != null}">
            <div class="img-secundarias-arriendo">
              <div class="img-sec-1">
                <img
                  id="img-sec-1"
                  src="/recursos/${post.imagen2.rutaImagen}"
                  alt="image 2"
                />
              </div>
              ...
              <c:if test="${post.imagen3 != null}">
                <div class="img-sec-2">
                  <img
                    id="img-sec-2"
                    src="/recursos/${post.imagen3.rutaImagen}"
                    alt="add image icon"
                  />
                </div>
              </c:if>
              ...
              <a href="/perfil/${usuarioActual.id}">
                <div class="izq-img">
                  ...
                  <div class="caja-1">
                    <div class="username">
                      <h1>
                        ${post.domicilio} de ${post.creador.nombre} en
                        ${post.direccion.ciudad}
                      </h1>
                      <img
                    ...
                    <p>
                      Dirección: ${post.direccion.direccion},
                      ${post.direccion.ciudad}
                    </p>
                  </div>
                </div>
