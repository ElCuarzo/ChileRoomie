        ...
        <main class="main">
          ...
          <section class="images">
            <div class="images-arriendo">
              ...
              <c:if test="${post.imagen2 == null}">
                <c:if test="${post.creador.id.equals(userid)}">
                  <div class="img-secundarias-arriendo">
                    <div class="img-sec-1">
                      <a href="/publicacion/${post.id}/addImage">
                        <img id="img-sec-1" src="/images/imgicon.png" alt="add image icon" />
                      </a>
                    </div>
                  </div>
                </c:if>
              ...
              <c:if test="${post.imagen2 != null}">
                <div class="img-secundarias-arriendo">
                  <div class="img-sec-1">
                    <img id="img-sec-1" src="/recursos/${post.imagen2.rutaImagen}" alt="image 2" />
                  </div>

                  <!--  third image doesnt exist -->
                  <c:if test="${post.imagen3 == null}">
                    <c:if test="${post.creador.id.equals(userid)}">
                      <div class="img-sec-2">
                        <a href="/publicacion/${post.id}/addImage">
                          <img id="img-sec-2" src="/images/imgicon.png" alt="add image icon" />
                        </a>
                      </div>
                    </c:if>
                  </c:if>
                  ...
                  <c:if test="${post.imagen3 != null}">
                    <div class="img-sec-2">
                      <img id="img-sec-2" src="/recursos/${post.imagen3.rutaImagen}" alt="add image icon" />
                    </div>
                  </c:if>
                </div>
              </c:if>
